...
> {
  ...
  public readonly tiene_un: BelongsToAccessor<Role, typeof Usuario.prototype.id>;
  ...
  constructor(
    ...
    this.tiene_un = this.createBelongsToAccessorFor('tiene_un', roleRepositoryGetter,);
